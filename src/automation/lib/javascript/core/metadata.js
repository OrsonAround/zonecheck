...
(function (context) {
  ...
  var log = Java.type('org.slf4j.LoggerFactory').getLogger(
    'jsr223.javascript.core.metadata'
  );
  ...
  try {
    var MetadataRegistry = get_service(
  ...
  context._merge_configuration = function (
  ...
  context.set_metadata = function (
    ...
    if (metadata === null || overwrite) {
      ...
      MetadataRegistry.add(
        new Metadata(
          new MetadataKey(namespace, item_name),
          value,
          configuration
        )
      );
      ...
      var new_configuration = _merge_configuration(
  ...
  context.set_value = function (item_name, namespace, value) {
    /*
        ...
        */
    log.debug('set_value: Item [{}], namespace [{}], value [{}]', [
      item_name,
      namespace,
      value,
    ]);
  ...
  context.get_key_value = function (item_name, namespace, key) {
    /*
        ...
        Returns:
            ...
            null: metadata or Item does not exist
        */
    log.debug('get_key_value: Item [{}], namespace [{}], key [{}]', [
      item_name,
      namespace,
      key,
    ]);
  ...
  context.set_key_value = function (item_name, namespace, key, value) {
    ...
    if (metadata) {
      new_configuration = _merge_configuration(
        metadata.configuration,
        new_configuration
      );
    }
  ...
  context.remove_key_value = function (item_name, namespace, key) {
    /*
        ...
        */
    log.debug('remove_key_value: Item [{}], namespace [{}], key [{}]', [
      item_name,
      namespace,
      key,
    ]);
